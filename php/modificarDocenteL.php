<?php
    ...
    function cargarDatos(){
        ...
        $sql="select * from docente where codigo='$cod';";
    ...
    function modificarDatos(){
        ...
        try {
            ...
            $sql="update docente set codigo='$codigo',nombre='$nom', paterno='$pat',materno='$mat',ci=$ci, extension='$ext',foto='$foto' where codigo='$cod';";
    ...
    function eliminarDatos(){
        ...
        try {
            ...
            $sql="delete from docente where codigo='$cod';";
            if(mysqli_query($conn,$sql)){
                echo 0;
            }
            else{
